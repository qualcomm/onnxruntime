...
class TestOpMatMul4Bits(unittest.TestCase):
    ...
    def quant_test(
        ...
        try:
            check_model_correctness(self, model_fp32_path, model_int8_path, data_reader.get_next(), rtol, atol,
    ...
    # def test_quantize_matmul_int8_offsets(self):
    ...
    #     data_reader = self.input_feeds(1, {"input": (2, 52)})
    #     for config in ["default"]:
    #         self.quant_test(model_fp32_path, data_reader, 32, True, atol=0.1, rtol=0.1, config=config)
